    ...
    try:
        ...
        for pl in push_level:
            for scenario, output_spec in scenarios.items():
                system_prompt, meta_prompt = build_meta_prompt(
                    push_level=pl,
                    scenario=scenario,
